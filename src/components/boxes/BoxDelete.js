      ...
      {(boxDelete, { loading, error }) => {
        ...
        return (
          <Modal
            ...
            title={`Are you sure you want to delete ${instance.shopifyBox.shopify_title}?`}
            primaryAction={{
          ...
          >
            <Modal.Section>
              ...
              { isLoading ? isLoading :
                <TextContainer>
                  <p>
                    Deleting <strong>{ instance.shopifyBox.shopify_title }</strong> This action cannot be undone.
                  </p>
                </TextContainer>
              }
            </Modal.Section>
